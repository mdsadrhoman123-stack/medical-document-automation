...
<img src="assets/demo.gif" alt="Medical Document Automation: one execution running step by step, a step failing on purpose — held and escalated, in red — then that same step handled and the run completing" width="100%">

<p align="center">16 pipeline stages · <b>6 failure paths, every one alerted</b> · 1 mandatory sign-off gate · 0 unreviewed patient outputs</p>
...
<img src="assets/output.png" alt="Medical Document Automation: sample of the output a client receives, including one step that failed and what happened instead" width="100%">
