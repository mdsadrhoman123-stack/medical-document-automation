...
<!-- Professional Banner -->
<img src="assets/banners/healthcare-banner.svg" alt="Healthcare Document Automation" style="width: 100%; max-width: 1200px; height: auto; border-radius: 10px; margin: 20px 0; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
